...
export function PaymentBadge({ payment, order, showReference = false }: Props) {
  ...
  return (
    <div className="space-y-0.5">
      <span
        className={`inline-flex shrink-0 whitespace-nowrap rounded-full border px-2 py-1 text-xs font-semibold md:px-1.5 md:py-0.5 md:text-[10px] ${tone}`}
      >
        {label}
      </span>
